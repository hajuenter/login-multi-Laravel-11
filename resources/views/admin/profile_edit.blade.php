...
@section('admin')
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('admin/editprofile') }}"><h3>Edit Profile</h3></a></li>
            </ol>
        </nav>
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{ url('admin/users/add') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="email" required placeholder="Email" value="{{ old('email') }}">
                                    <span style="color: red;">{{ $errors->first('email') }}</span>
                                </div>
                            </div>
                            {{-- photo --}}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Alamat" required placeholder="Alamat" value="{{ old('phone') }}">
                                    <span style="color: red;">{{ $errors->first('phone') }}</span>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">About <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="phone" required placeholder="About" value="{{ old('phone') }}">
                                    <span style="color: red;">{{ $errors->first('phone') }}</span>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="phone" required placeholder="Website" value="{{ old('phone') }}">
                                    <span style="color: red;">{{ $errors->first('phone') }}</span>
                                </div>
                            </div>
                            <div class="row mb-3">
